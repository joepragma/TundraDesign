...
void UPragmaFleetPartnerServiceRaw::OnInitialized()
{
}

#define IMPL_PRAGMA_METHOD(FunctionName, RequestType, ResponseType, DelegateType) \
IMPL_PRAGMA_GAME_METHOD(UPragmaFleetPartnerServiceRaw, FunctionName, RequestType, ResponseType, DelegateType)

IMPL_PRAGMA_METHOD(ReportCapacityV1, FPragma_Fleet_ReportCapacityV1Request, FPragma_Fleet_ReportCapacityV1Response, FReportCapacityV1Delegate);
