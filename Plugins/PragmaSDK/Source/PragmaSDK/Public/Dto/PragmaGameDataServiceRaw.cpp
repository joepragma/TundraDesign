...
void UPragmaGameDataServiceRaw::OnInitialized()
{
}

#define IMPL_PRAGMA_METHOD(FunctionName, RequestType, ResponseType, DelegateType) \
IMPL_PRAGMA_GAME_METHOD(UPragmaGameDataServiceRaw, FunctionName, RequestType, ResponseType, DelegateType)

IMPL_PRAGMA_METHOD(GetLoginDataV3, FPragma_GameData_GetLoginDataV3Request, FPragma_GameData_GetLoginDataV3Response, FGetLoginDataV3Delegate);
