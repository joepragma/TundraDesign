...
private:
	...
	FPragma_Party_BroadcastPartyMember StubbedClientPartyPlayer(const bool IsLeader) const;
	FPragma_Party_BroadcastPartyMember StubbedRandomPartyPlayer(const bool IsLeader) const;
